...
# 1.
```{r}
cholest <-  as.data.frame(read_excel("C:/Users/nabib/Documents/GitHub/Statics/1026/table4.4_cholesterol.xlsx"))
cholest
```
...
# 3.
```{r}
fighter <-  as.data.frame(read_excel("C:/Users/nabib/Documents/GitHub/Statics/1026/table4.6_fighter.xlsx"))
fighter
```
